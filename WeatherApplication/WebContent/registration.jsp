...
<html>
    ...
    <body>
     <div class="container">
        <form class="form-card" method="post" action="${pageContext.request.contextPath}/RegistrationServlet">
            <center>
            <table width="100%" cellpadding="5">
                <thead>
                    <tr>
                         <th colspan="2"><div class="form-head row">Enter Information Here</div></th>
                    </tr>
                </thead>
                <tbody>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td class="text-center" colspan="2"><input class="btn btn-primary" type="submit" value="Submit" /></td>
                    </tr>
                    <tr><td colspan="2"><div class="form-group"></div></td></tr>
                    <tr>
                        <td class="text-right" colspan="2">Already registered!! <a href="login.jsp">Login Here</a></td>
                    </tr>
                </tbody>
            </table>
            </center>
